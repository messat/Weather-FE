...
const getWeather = async ()=>{
  ...
  toast.info(`Fetching weather data for ${cityName[0].toUpperCase() + cityName.slice(1)}`)
...
const formatBackground = ()=>{
  ...
  return "from-yellow-600 to-orange-700"
   ...
   return (
     ...
     <ToastContainer autoClose={2500} hideProgressBar={true} theme="colored" transition={Bounce}/>
     </div>
   )
 }
